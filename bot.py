...
def Seller_Tools_keys():
    keyboard = [
        ...
        [InlineKeyboardButton("🆘 آموزش", callback_data='help'), InlineKeyboardButton("🖥 حساب کاربری", callback_data='UWM')],
...
def User_Tools_keys():
    keyboard = [
        [InlineKeyboardButton("🖥 حساب کاربری", callback_data='UWM')],
    ...
    if settings['list_status'] == "on":
        for i in range(len(keyboard)):
            if InlineKeyboardButton("🖥 حساب کاربری", callback_data='UWM') in keyboard[i]:
...
def call_Confirmed_deposit(bot, query):
    ...
    if check_code_exists(code) is True:
        ...
        try:
            ...
            update_user_wallet(chat_id, value)
            add_check_admin(query.message.chat.id, query.message.chat.first_name, username_admin, code, "Yes", int(time()))
            keyboard = [[InlineKeyboardButton("🖥 حساب کاربری", callback_data='UWM')]]
            reply_markup = InlineKeyboardMarkup(keyboard)
